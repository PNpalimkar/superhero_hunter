var script = function(){
    const PRIV_KEY = "da5aafdff6ebeddaa9bc8db4b9e87dbc02ca049a";
    const PUBLIC_KEY = "9798c70d3a564b5b348e0faab8ac5062";
    const featuredcharID = [1009368, 1017327, 1010971, 1017303]; //IDs of characters to be displayed as feaured characters
                ...
                .then(
                    function (data) {
                        ...
                        for (var i=0; i<arr.length; i++){
                            ...
                            /*card created using template literal*/
    ...
    //if search button is clicked, check if character exists and only then load.
